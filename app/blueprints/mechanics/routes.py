...
def mechanics_ranking():  # noqa: C901
    ...
    try:
        ...
        for mechanic in mechanics:
            ...
            ticket_count = (
                len(mechanic.tickets)
                if hasattr(mechanic, "tickets") and mechanic.tickets
                else 0
            )

            # Build mechanic data safely
            mechanic_info = {"id": mechanic.id, "ticket_count": ticket_count}
        ...
        return jsonify({"success": True, "data": mechanics_data}), 200
